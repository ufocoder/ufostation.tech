...
pubDate: 'Sep 17 2022'
tags: ['history']
heroImage: 'https://images.unsplash.com/photo-1611264327630-8090373c8cef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1254&q=80'
...
Вы когда-нибудь задумывались почему на первых страницах книг по изучению ЯП в листингах кода используется фраза «Hello, World»? Эта фраза также встречается в ознакомительных курсах или вводных статьях по какому-нибудь ЯП. Возможно современные авторы и разработчики копируют опыт прошлого поколения, но тогда откуда его копировали вторые?
...
<Img height="320" src="/assets/posts/2022/hello-world/brian-kernighan.jpg" />

_Брайан Керниган. Университет Мэриленд (1982)_
...
<Attachment url="http://cslabcms.nju.edu.cn/problem_solving/images/c/cc/The_C_Programming_Language_%282nd_Edition_Ritchie_Kernighan%29.pdf">
	The C Programming Language Брайан Керниган, 1978 год
</Attachment>
