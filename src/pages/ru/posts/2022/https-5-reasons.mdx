...
pubDate: 'Dec 31 2022'
description: 'Когда речь заходит об использовании HTTPS первое, что приходит в голову это шифрование передаваемого по сети трафика. На самом деле это следствий использования этого протокола несколько больше.'
---
